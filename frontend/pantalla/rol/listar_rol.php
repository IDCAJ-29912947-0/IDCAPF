	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-3 col-12 border border-white text-center">
		  <a href="<?php echo "ver_rol.php?cod_rol=$datos[cod_rol]"?>">Ver</a> 
		  <a href="<?php echo "modificar_rol.php?cod_rol=$datos[cod_rol]"?>">Editar</a>  
		</div>
		...
		<div class="col-md-3 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_rol']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
