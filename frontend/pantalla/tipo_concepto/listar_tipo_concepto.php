...
<head>
	<meta charset="UTF-8">
	<title>Listar Tipo de Concepto</title>
...
<form action="listar_tipo_concepto.php" method="POST">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-4 col-12 border border-white ">
		     <span>Nombre del Tipo de Concepto</span>
		</div>
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_tip_con,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-3 col-12 border border-white text-center">
		  <a href="<?php echo "ver_tipo_concepto.php?cod_tip_con=$datos[cod_tip_con]"?>">Ver</a> 
		  <a href="<?php echo "modificar_tipo_concepto.php?cod_tip_con=$datos[cod_tip_con]"?>">Editar</a>  
		</div>

		<div class="col-md-2 col-12 border border-white">
		     <span><?php echo $datos['cod_tip_con']; ?></span>
		</div>

		<div class="col-md-4 col-12 border border-white text-left text-capitalize">
		     <span><?php echo $datos['nom_tip_con']; ?></span>
		</div>

		<div class="col-md-3 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_tip_con']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
