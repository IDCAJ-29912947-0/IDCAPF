	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2">
		<div class="col-4">Email:</div>
			<div class="col-8">
				<input type="email" name="ema_usu" id="ema_usu" placeholder="email@email.com" class="form-control" value="<?php echo $datos['ema_usu'] ?>" required="">
			</div>
		</div>
		...
		<div class="row mt-2">
			...
			<div class="col-8">
				<input type="text" name="nom_usu" id="nom_usu" placeholder="Nombre" class="form-control" pattern="[a-zA-Z ]+" title="Solo Letras" value="<?php echo $datos['nom_usu'] ?>" required="">
			</div>
		</div>
		<div class="row mt-2">
			<div class="col-4">Apellido:</div>
			<div class="col-8">
				<input type="text" name="ape_usu" id="ape_usu" placeholder="Apellido" class="form-control" pattern="[a-zA-Z ]+" title="Solo Letras" value="<?php echo $datos['ape_usu'] ?>" required="">
			</div>
		</div>
		<div class="row mt-2">
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar usuario">
		</div>
	   </div>	
