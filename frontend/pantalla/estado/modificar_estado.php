	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-9 col-12">
		    <input type="text" name="nom_est" id="nom_est" required="required" maxlength="35" class="form-control" placeholder="Nombre del Estado" 
		    value="<?php echo $datos['nom_est']; ?>" pattern="[a-zA-Z0-9 ]+" title="Solo valores Alfa-Númericos" required>
		</div>
