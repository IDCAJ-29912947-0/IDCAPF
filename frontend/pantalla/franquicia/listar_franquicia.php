...
<form action="listar_franquicia.php" method="POST">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-4 col-12 border border-white ">
		     <span>Nombre del Franquicia</span>
		</div>
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_fra,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-3 col-12 border border-white text-center">
		  <a href="<?php echo "ver_franquicia.php?cod_fra=$datos[cod_fra]"?>">Ver</a> 
		  <a href="<?php echo "modificar_franquicia.php?cod_fra=$datos[cod_fra]"?>">Editar</a>  
		</div>

		<div class="col-md-2 col-12 border border-white">
		     <span><?php echo $datos['cod_fra']; ?></span>
		</div>

		<div class="col-md-4 col-12 border border-white text-left text-capitalize">
		     <span><?php echo $datos['nom_fra']; ?></span>
		</div>

		<div class="col-md-3 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_fra']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
