	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-8 col-12">
		    <input type="text" name="nom_ser" id="nom_ser" required="required" maxlength="35" class="form-control" placeholder="Nombre del Servicio" value="<?php echo $servicio['nom_ser']?>" pattern="[a-zA-Z0-9 ]+" title="Solo valores Alfa-Númericos" required>
		</div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-8 col-12">
		    <input type="text" name="pre_ser" id="pre_ser" required="required" maxlength="35" class="form-control" placeholder="Precio del Servicio" value="<?php echo $servicio['pre_ser']?>" pattern="[0-9.]+" title="Solo valores Númericos y caracteres especiales cómo ( . )" required="">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar Servicio">
		</div>
	   </div>	  	  
    </div>
  </div>
...
<input type="hidden" name="cod_ser" id="cod_ser" value="<?php echo $servicio["cod_ser"];?>">		
</form>	
</body>
</html>
