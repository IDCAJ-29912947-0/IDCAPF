	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="text" name="nom_mod" id="nom_mod" required="required" maxlength="35" class="form-control" placeholder="Nombre del Modelo" onkeyup="return solo_letras();" value="<?php echo $modelo['nom_mod']?>" disabled>
		</div>
