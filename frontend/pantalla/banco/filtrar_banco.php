	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-9 col-12">
		    <input type="text" name="nom_ban" id="nom_ban" maxlength="50" class="form-control" placeholder="Nombre del Banco" pattern="[a-zA-Z0-9 ]+" title="Solo valores Alfa-Númericos">
		</div>
