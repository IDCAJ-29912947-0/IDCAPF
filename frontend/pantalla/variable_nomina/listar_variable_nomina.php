...
<form action="listar_variable_nomina.php" method="POST">
	...
	<div class="col-12 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-2 col-12 border border-white ">
		     <span>Nombre del Variable</span>
		</div>

		<div class="col-md-4 col-12 border border-white ">
		     <span>Descripción Variable</span>
		</div>
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_var_nom,"");
		...
		<div class="col-md-2 col-12 border border-white text-left text-capitalize">
		     <span><?php echo $datos['nom_var_nom']; ?></span>
		</div>


		<div class="col-md-4 col-12 border border-white text-left text-capitalize">
		     <span><?php echo $datos['des_var_nom']; ?></span>
		</div>


		<div class="col-md-2 col-12 border border-white">
		     <span><?php echo $datos['val_var_nom']; ?></span>
		</div>		

		<div class="col-md-2 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_var_nom']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
