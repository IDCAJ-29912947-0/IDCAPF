...
$resultado=$obj->filtrar($obj->cod_mar,$nom_mar="",$est_mar="");
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-4 col-12">
		    <input type="text" class="form-control" value="<?php echo $datos['cod_mar']; ?>" readonly>
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="text"  class="form-control text-capitalize" value="<?php echo $datos['nom_mar']; ?>" size="35" readonly >
		</div>
	  ...
	  <fieldset disabled>
		 ...
		 $selected = ($datos['est_mar']=='I') ? "selected":"";
