	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="text" name="fec_ord" id="fec_ord" required="" class="form-control" value="<?php echo $orden_servicio['fec_ord']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-9 col-12">
		    <input type="text" name="kms_ord" id="kms_ord" required="required" maxlength="25" class="form-control" placeholder="Kilometros" pattern="[0-9]+" title="Solo Números" value="<?php echo $orden_servicio['kms_ord']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="date" name="fet_ord" id="fet_ord" required="" class="form-control"  value="<?php echo $orden_servicio['fet_ord']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="date" name="fee_ord" id="fee_ord" required="" class="form-control" value="<?php echo $orden_servicio['fee_ord']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-9 col-12">
		    <input type="text" name="aut_ord" id="aut_ord" required="required" maxlength="20" class="form-control" placeholder="" pattern="[a-zA-Z0-9 ]+" title="Solo valores Alfa-Númericos" value="<?php echo $orden_servicio['aut_ord']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-9 col-12">
		    <input type="text" name="obs_ord" id="obs_ord" required="required" maxlength="80" class="form-control" placeholder="obs_ord" pattern="[a-zA-Z0-9 ]+" title="Solo Valores Alfa-Numéricos" value="<?php echo $orden_servicio['obs_ord']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar Orden de Servicio">
		</div>
	   </div>	 
