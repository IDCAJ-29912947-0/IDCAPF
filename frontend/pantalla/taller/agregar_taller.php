	...
	<div class="col-md-11">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-9 col-12">
		    <input type="text" name="te2_tal" id="te2_tal" maxlength="15" class="form-control" placeholder="Teléfono Secundario" pattern="[a-zA-Z0-9#.,-/ ]+" title="Solo valores Alfa-Númericos incluyendo los caracteres especiales ( # ) ( . ) ( , ) ( - ) ( / )">
		</div>
