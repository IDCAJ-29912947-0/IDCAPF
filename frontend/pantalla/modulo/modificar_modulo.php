	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-4 col-12">
		    <input type="text" name="nom_mod" id="nom_mod" required="required" maxlength="50" class="form-control text-capitalize" placeholder="Nombre del Módulo" value="<?php echo $datos['nom_mod']; ?>" pattern="[a-zA-Z0-9 ]+" title="Solo valores Alfa-Númericos" required="">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		  ...
		  <div class="col-8">
			  <input type="text" name="url_mod" id="url_mod" placeholder="modulo/" maxlength="50" class="form-control" value="<?php echo $datos['url_mod']; ?>" pattern="[a-zA-Z0-9/._?]+" title="Solo valores Alfa-Númericos y caracteres especiales cómo ( / ) ( . ) ( _ ) ( ? )" required>
		  </div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar Módulo">
		</div>
	   </div>	
